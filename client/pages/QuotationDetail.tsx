        ...
        <body>
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <div class="info-value">${quotation.companyName}</div>
            </div>
            <div class="info-item">
              <div class="info-label">Reason</div>
              <div class="info-value">${quotation.reason}</div>
            </div>
            <div class="info-item">
              <div class="info-label">Quantity</div>
              <div class="info-value">${quotation.quantity}</div>
            </div>
            <div class="info-item">
              <div class="info-label">Date</div>
              <div class="info-value">${new Date(quotation.date).toLocaleDateString()}</div>
            </div>
            <div class="info-item">
              <div class="info-label">Created By</div>
              <div class="info-value">${quotation.createdBy}</div>
            </div>
            <div class="info-item">
          ...
          <div class="summary">
            <div>
              ...
              <div class="info-value" style="color: green;">₹${totalCost.toFixed(2)}</div>
            </div>
          </div>
        </body>
        </html>
