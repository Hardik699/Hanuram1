              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <thead className="bg-gradient-to-r from-blue-600 to-blue-700 text-white sticky top-0">
                    <tr>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">Unit Name</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">Short Code</th>
