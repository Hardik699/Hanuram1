        ...
        {opCosts.length === 0 ? (
          <div className="bg-card rounded-lg p-12 border text-center">
            <p className="text-muted-foreground">
              No OP cost entries found. Create one to get started!
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-4">
            {opCosts.map((opCost) => (
              <div
                key={opCost._id}
                className="bg-card rounded-lg p-6 border hover:shadow-md transition"
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold">
                      {(
                        opCost.production.mithaiProduction +
                        opCost.production.namkeenProduction
                      ).toFixed(2)}{" "}
                      Kg
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-lg font-bold text-blue-600">
                      ₹{opCost.autoOpCostPerKg.toFixed(2)}/Kg
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground">
                    ...
                    <p className="text-lg font-bold text-green-600">
                      ₹
                      {(opCost.useManualOpCost && opCost.manualOpCostPerKg
                        ? opCost.manualOpCostPerKg
                        : opCost.autoOpCostPerKg || 0
                      ).toFixed(2)}
                      /Kg
                    </p>
                    {opCost.useManualOpCost && (
