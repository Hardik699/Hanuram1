    ...
    return (
      <Layout title="Loading...">
        <div className="flex items-center justify-center py-12">
          ...
          <p className="text-slate-600 ml-3 font-medium">
            Loading...
          </p>
        </div>
      </Layout>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200/50 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6 border-t border-slate-200
              ...
              {/* Add Item Form */}
              {showAddItemForm && (
                <div className="bg-slate-50 rounded-lg border border-slate-200 p-4 mb-6 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 rounded-lg bg-white border border-slate-200 text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 rounded-lg bg-white border border-slate-200 text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm disabled:opacity-50"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 rounded-lg bg-white border border-slate-200 text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 rounded-lg bg-white border transition-all ${
                        itemErrors.rawMaterial
                          ? "border-red-500
                          : "border-slate-200
                      } text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm`}
                    >
                          ...
                          <td className="px-4 py-3 text-sm text-slate-600
                            {editingItemIndex === index ? (
                              <select
                                ...
                                className="px-2 py-1 rounded border border-slate-300 bg-white text-slate-900 text-sm"
                              >
                                <option value="">Default</option>
                                {units.map((unit) => (
                                  <option key={unit._id} value={unit._id}>
                            ...
                            {editingItemIndex === index ? (
                              <>
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-green-100 text-green-700 rounded hover:bg-green-200 transition-colors"
                                >
                                ...
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-slate-200 text-slate-700 rounded hover:bg-slate-300 transition-colors"
                                >
                                  <X className="w-4 h-4" />
                                  Cancel
                                </button>
                              ...
                              <>
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-100 text-blue-700 rounded hover:bg-blue-200 transition-colors"
                                >
                                ...
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-red-100 text-red-700 rounded hover:bg-red-200 transition-colors"
                                >
